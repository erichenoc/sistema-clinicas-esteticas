...
export const EXPENSE_CATEGORIES: ExpenseCategoryDef[] = [
  ...
  },
  {
    ...
    subcategories: ['Aparatología', 'Mobiliario', 'Computadoras', 'Instrumental'],
  },
  {
    key: 'mantenimiento',
    label: 'Mantenimiento',
  ...
  },
  {
    key: 'marketing',
    label: 'Marketing',
    description: 'Publicidad, redes sociales y promoción',
    subcategories: ['Publicidad pagada', 'Diseños', 'Influencers', 'Material promocional'],
  },
  {
    key: 'transporte',
    label: 'Transporte',
    description: 'Combustible, delivery y mensajería',
    subcategories: ['Combustible', 'Delivery', 'Mensajería', 'Peajes'],
  },
  {
    key: 'otros',
    label: 'Otros',
    description: 'Gastos que no encajan en las demás categorías',
    subcategories: [],
  },
]
